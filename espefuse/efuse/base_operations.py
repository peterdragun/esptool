...
class BaseCommands:
    ...
    def dump(self, format: str = "default", file_name: str | None = None):
        ...
        def output_block_to_file(
            block: base_fields.EfuseBlockBase, f: BinaryIO, to_console: bool
        ):
        ...
        if format == "split":
            ...
            for block in self.efuses.blocks:
                if not to_console:
                    ...
                    dump_file: BinaryIO = open(file_dump_name, "wb")
    ...
    def burn_custom_mac(self, mac: bytes):
        """
        Burn a 48-bit Custom MAC Address.

        Args:
            mac (bytes): Custom MAC Address to burn. e.g. b'\xaa\xcd\xef\x11\x22\x33'
        """
